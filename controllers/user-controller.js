...
const userController = {
  ...
  addFavorite: (req, res, next) => {
    ...
    return Promise.all([
      ...
      .then(([restaurant, favorite]) => {
        ...
        if (favorite) throw new Error('The restaurant is already on your list.')
  ...
  removeFavorite: (req, res, next) => {
    return Favorite.findOne({
      ...
      .then(favorite => {
        if (!favorite) throw new Error("The restaurant is not on your list.")
  ...
  addLike: (req, res, next) => {
    ...
    return Promise.all([
      ...
      .then(([restaurant, like]) => {
        if (!restaurant) throw new Error("Restaurant doesn't exist!")
        if (like) throw new Error('The restaurant is already on your like list.')
        return Like.create({
          userId: req.user.id,
          restaurantId
        })
  ...
  removeLike: (req, res, next) => {
    return Like.findOne({
      ...
      .then(like => {
        if (!like) throw new Error("The restaurant is not on your like list.")
        return like.destroy()
      })
      .then(() => res.redirect('back'))
      .catch(err => next(err))
